...
htmlhelp_basename = 'ModellingEarthdoc'
...
latex_documents = [
    (master_doc, 'ModellingEarth.tex', 'Modelling Earth Documentation',
     'Agustina Pesce', 'manual'),
]
...
man_pages = [
    (master_doc, 'modellingearth', 'Modelling Earth Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ModellingEarth', 'Modelling Earth Documentation',
     author, 'ModellingEarth', 'One line description of project.',
     'Miscellaneous'),
]
...
html_context = {
    ...
    'menu_links': [
        ('<i class="fa fa-github fa-fw"></i> Source Code', 'https://github.com/aguspesce/modellin_earth'),
    ],
